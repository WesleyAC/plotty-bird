...
fn main() -> Result<(),Error> {
    ...
    let explode_cmds: Vec<String> = vec!["PU;", "PR-270,-300;", "PD;", "PR-40,200;", "PR-120,80;", "PR160,110;", "PR-40,200;", "PR160,-110;", "PR20,200;", "PR120,-180;", "PR140,120;", "PR20,-140;", "PR170,30;", "PR-140,-100;", "PR160,-70;", "PR-160,-70;", "PR140,-120;", "PR-160,-20;", "PR20,-150;", "PR-140,120;", "PR-100,-120;", "PR-90,100;", "PR-120,-80;", "PU;", "PA0,0;", "SP0;", "PA-5000,0;"].iter().map(|x| x.to_string()).collect();
